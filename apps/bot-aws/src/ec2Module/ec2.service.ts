...
import { IdolsDbService } from '@bigo-bot/common/idols-db/idols-db.service'

@Injectable()
export class Ec2Service {
  private readonly ec2Client: EC2Client
  private readonly idolDbService: IdolsDbService

  constructor (idolDbService: IdolsDbService) {
    this.ec2Client = new EC2Client({ region: 'us-east-1' })
    this.idolDbService = idolDbService
  }
